    ...
    def update(self):
        ...
        for service_item in services:
            ...
            for role_item in service['components']:
                ...
                #host_info = requests.get('%s/hosts/%s' % (self._ambari_api, role_host), auth=self._http_auth, headers=self._http_headers).json()
                #check whether host specific issues need to be added too, like low disk space
